...
export const gerarPDFProvaVisual = async (simulacao) => {
  ...
  await renderReactToPdf(
    ...
    { simulacao, imagemSimulacao: imagemBase64, dataText, isGabarito: false }, 
    filename
  );
};
