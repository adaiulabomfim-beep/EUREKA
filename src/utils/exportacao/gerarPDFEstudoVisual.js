...
export const gerarPDFEstudoVisual = async (simulacao, instituicao = '', disciplina = '', professor = '', aluno = '') => {
  try {
    ...
    // Isso economiza tempo e impede que o navegador bloqueie o download por inatividade
    ...
    forcarDownloadPDF(doc, `Relatorio_Visual_EUREKA_Estudo_${now.getTime()}.pdf`);
  } catch (error) {
    console.error("Erro ao gerar PDF de estudo:", error);
