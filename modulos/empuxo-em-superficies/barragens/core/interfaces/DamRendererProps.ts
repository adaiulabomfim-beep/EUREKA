...
export interface DamViewProps {
  ...
  prism: (profile: any[], zWidth: number, fill: string, opacity: number, stroke?: string, strokeWidth?: number, kind?: "DAM" | "WATER", xOffsetFn?: (z: number) => number, zOffset?: number, hatchPattern?: string, toWorldX?: (x: number) => number) => any[];
