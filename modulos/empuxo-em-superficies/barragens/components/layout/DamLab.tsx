...
import { Layers, Construction, Calculator, FileText, RotateCw, MoveVertical, Maximize, AlertCircle } from 'lucide-react';
        ...
        <div className="lg:col-span-3 flex flex-col gap-4 h-full">
             <div className="bg-white/75 backdrop-blur-md border border-blue-100/70 p-5 rounded-2xl shadow-xl shadow-blue-200/20 flex flex-col h-full">
                 <div className="flex items-center justify-between mb-6 pb-2 border-b border-blue-50">
                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">Resultados (por metro)</h3>
                 </div>
                    ...
                    <div className="space-y-4 flex-1 overflow-y-auto custom-scrollbar pr-1 animate-in fade-in slide-in-from-bottom-2">
                         ...
                         <div className="group bg-white/50 p-4 rounded-xl border border-blue-100 shadow-sm hover:shadow-md transition-all relative overflow-hidden">
                             ...
                             <div className="text-2xl font-mono font-black text-slate-800 flex items-center gap-2">
                                 {(Math.abs(analyzedResults.forceData.FR_net) / 1000).toFixed(2)} <span className="text-sm font-sans font-black text-slate-400 self-end mb-1">kN/m</span>
                             </div>
                         </div>
                         ...
                         <div className="bg-blue-50/30 p-4 rounded-xl border border-blue-100/50">
                             ...
                             <div className="grid grid-cols-2 gap-3">
                                 <div className="bg-white/70 p-2.5 rounded-lg border border-blue-100"><div className="text-[9px] text-slate-400 uppercase tracking-widest font-black">Área Molhada (M)</div><div className="font-mono font-black text-slate-700 text-sm mt-0.5">{analyzedResults.forceData.up.area.toFixed(2)} m²/m</div></div>
                                 <div className="bg-white/70 p-2.5 rounded-lg border border-blue-100"><div className="text-[9px] text-slate-400 uppercase tracking-widest font-black">Área Molhada (J)</div><div className="font-mono font-black text-slate-700 text-sm mt-0.5">{analyzedResults.forceData.down.area.toFixed(2)} m²/m</div></div>
                             </div>
                         </div>
                    </div>
                 ) : (
