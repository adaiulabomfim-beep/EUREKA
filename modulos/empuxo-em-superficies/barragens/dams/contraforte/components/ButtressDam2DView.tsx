...
import { useButtressDamSimulation } from '../hooks/useButtressDamSimulation';
...
export const ButtressDam2DView: React.FC<DamRendererProps & { is3D: boolean, setIs3D: any, showVectors: boolean, setShowVectors: any }> = (props) => {
  const {
  ...
  const { worldGeometry, getDamXAtY, profile } = useButtressDamSimulation({
    damHeight, damBaseWidth, damCrestWidth, inclinationAngle,
