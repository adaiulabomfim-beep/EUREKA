  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-white/75 backdrop-blur-md border border-blue-100/70 p-6 rounded-2xl shadow-xl shadow-blue-200/25">
        <h3 className="text-lg font-bold text-blue-700 mb-3 border-b border-blue-100/50 pb-2 tracking-tight">Fundamentos Teóricos</h3>
      ...
      {/* Hydrostatics */}
      <div className="bg-white/75 backdrop-blur-md border border-blue-100/70 p-6 rounded-2xl shadow-xl shadow-blue-200/25">
        <h3 className="text-lg font-bold text-cyan-700 mb-3 border-b border-cyan-100/50 pb-2 tracking-tight">Lei de Stevin & Hidrostática</h3>
        <p className="text-slate-600 mb-4 text-sm leading-relaxed">
      ...
      <div className="bg-white/75 backdrop-blur-md border border-blue-100/70 p-6 rounded-2xl shadow-xl shadow-blue-200/25 md:col-span-2">
        <h3 className="text-lg font-bold text-emerald-700 mb-3 border-b border-emerald-100/50 pb-2 tracking-tight">Flutuabilidade e Estabilidade</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="p-4 bg-emerald-50/50 rounded-xl border border-emerald-100 text-center">
            <div className="font-bold text-emerald-800 mb-1">ρ<sub>corpo</sub> &lt; ρ<sub>fluido</sub></div>
